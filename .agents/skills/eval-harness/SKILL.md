...
Use a model grader to evaluate open-ended outputs:
```markdown
[MODEL GRADER PROMPT]
...
### Pre-Implementation
Create an eval definition file at `.codex/evals/feature-name.md`.

### During Implementation
Run the commands listed in the eval definition and append outcomes to `.codex/evals/feature-name.log`.

### Post-Implementation
Summarize the final results in the PR or release notes before landing the change.
...
### Phase 3: Evaluate
Run the commands defined in `.codex/evals/add-authentication.md`
